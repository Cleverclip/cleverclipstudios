...
<div class="sp sgl">
	...
	<div class="sp-header">
		<div class="cntr">
			...
			<?php cp_amp_title(); ?>
			<?php cp_amp_categories_list();?>
			<?php cp_amp_rt_reading_time();?>
			
			<?php if( true == ampforwp_get_setting('amp-author-name') ) { ?>
	            <div class="sp-athr">
	            	<?php amp_author_box( 
	            	    array(
	            	        'author_pub_name'=>true,
	            	        'author_info'=>true,
	            	        'avatar'=>true,
			            ...
			            <ul class="clearfix">
					        ...
					        <li class="<?php if ( has_post_thumbnail() ) { echo'has_thumbnail'; } else { echo 'no_thumbnail'; } ?>">
								...
								<div class="rlp-cnt">
									...
									cp_ampforwp_get_relatedpost_content($argsdata); ?> 
						        </div>
					        </li><?php
