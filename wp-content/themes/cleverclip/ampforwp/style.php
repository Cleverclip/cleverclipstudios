...
/* Start Custom Fonts CSS */@font-face {
	...
	font-weight: normal;
	font-display: auto;
	src: url('<?php echo get_template_directory_uri() ?>/ampforwp/fonts/TiemposHeadline-Regular.woff') format('woff');
}
@font-face {
	font-family: 'Tiempos Headline';
	font-style: normal;
	font-weight: bold;
	font-display: auto;
	src: url('<?php echo get_template_directory_uri() ?>/ampforwp/fonts/TiemposHeadline-Bold.woff') format('woff');
}
...
else{ ?>.cntr {max-width: 1100px;margin: 0 auto;width:100%;padding:0px 15px} <?php } ?>
...
.t-btn{display: block;height: 4rem;margin-top: -.433rem;right: 1.325rem;transform: translateY(-50%);}
.t-btn, .t-btn:after {position: absolute;top: 50%;width: 2.1rem;
}
.t-btn:after{
<?php if ( $ampforwp_font_icon == 'swift-icons'  && 1==2){ ?>
	content:"\e5d2";font-family: "icomoon";font-size:28px;
<?php }
if ( $ampforwp_font_icon == 'fontawesome-icons' && 1==2){ ?>
	content:"\f0c9";font-family: "Font Awesome 5 Free";font-weight:600;font-size:22px;
<?php } ?>
    background: currentColor;box-shadow: 0 -.59625rem 0 currentColor,0 .59625rem 0 currentColor;content: "";height: .1325rem;left: 50%;transform: translate(-50%,-50%);
<?php if( isset($redux_builder_amp['swift-element-color-control']['rgba']) && $redux_builder_amp['swift-element-color-control']['rgba']){ ?>color: <?php echo ampforwp_sanitize_color($redux_builder_amp['swift-element-color-control']['rgba'])?>;<?php } ?>}
.t-btn span{bottom: .3rem;font-family: Work Sans;font-size: 0.828rem;font-weight: 700;left: 50%;position: absolute;transform: translateX(-50%);
}
.menu-heading{height:3.975rem;border-bottom: 1px solid rgba(0,0,0,.5);}
...
<?php } ?>
<?php if(isset($redux_builder_amp['swift-element-overlay-color-control'] ['rgba']) && $redux_builder_amp['swift-element-overlay-color-control'] ['rgba']){?>color: <?php echo ampforwp_sanitize_color($redux_builder_amp['swift-element-overlay-color-control']['rgba'])?>;background: <?php echo ampforwp_sanitize_color($redux_builder_amp['swift-element-overlay-color-control']['rgba'])?>;<?php } ?>line-height: 0;text-indent: 1px;content: "";display: block;height: 1.9875rem;left: 50%;position: absolute;top: 50%;width: .1325rem;
}
.c-btn:before{transform: translate(-50%,-50%) rotate(-45deg);
}
.c-btn:after{transform: translate(-50%,-50%) rotate(45deg);
}
.c-btn{float: right;padding: 15px 5px;font-size: 0;height: 4rem;position: relative;width: 4rem;}
.c-btn-left{float:left;}
.m-ctr{transition: margin 0.3s ease-in-out;}
.m-ctr{<?php if(ampforwp_get_setting('header-overlay-width')){?>width:<?php echo esc_html(ampforwp_get_setting('header-overlay-width'))?>;<?php } ?>height:100%;position: absolute;z-index:99;padding: 0 0% 100vh 0%;}
.m-menu{display: inline-block;width: 100%;padding: 1.9875rem;}
...
<?php } ?>
    ...
    border-style: solid;
    border-width: .06625rem .06625rem 0 0;
    content: "";
    display: block;
    height: 0.6625rem;
    position: absolute;
    ...
    width: 0.6625rem;
    top: 2rem;
cursor: pointer;color: <?php echo ampforwp_sanitize_color($redux_builder_amp['swift-element-overlay-color-control']['rgba'])?>;}
.m-menu .amp-menu li.menu-item-has-children:after{display:none;}
.m-menu .amp-menu li ul{font-size:14px;}
.m-menu .amp-menu {list-style-type: none;padding: 0;}
.m-menu .amp-menu > li a{<?php if($redux_builder_amp['swift-element-overlay-color-control'] ['rgba']){?>color: <?php echo ampforwp_sanitize_color($redux_builder_amp['swift-element-overlay-color-control']['rgba'])?>;<?php } ?> padding: 0px 7px 0 0;margin-bottom:0;display:inline-block;
    font-size: 1.325rem;
    font-weight: 700;
    line-height: 3;
    position: relative;
...
.m-menu .amp-menu li:not(:first-child) {border-top: 1px solid rgba(0,0,0,.25);}
...
<?php } ?>
	...
	.m-menu .amp-menu [id^=drop]:checked + .toggle:after{transform:rotate(320deg);}
/*New Syles*/
<?php } ?>
...
if( is_page() || ampforwp_is_front_page() || ampforwp_polylang_front_page() ){?>
    <?php if(!checkAMPforPageBuilderStatus(ampforwp_get_the_ID())){ ?>
        ...
        .amp-post-title{font-size: 28px;line-height: 31px;color: #000;margin: 0;padding-top: 15px;}
        ...
        .cntn-wrp {font-size: 16px;color: #000;line-height: 1.58;}
...
if(1==ampforwp_get_setting('ampforwp-google-font-switch')){
    $fontFamily = "font-family: 'Poppins', sans-serif;";
    if(1==ampforwp_get_setting('content-font-family-enable') && isset($redux_builder_amp['amp_font_selector_content_single']) && $redux_builder_amp['amp_font_selector_content_single'] != 1 && !empty($redux_builder_amp['amp_font_selector_content_single'])){ 
		$fontFamily = "font-family: '".$redux_builder_amp['amp_font_selector_content_single']."';";
	} else {
	    $fontFamily = "font-family: 'Tiempos Headline', sans-serif;";
	}
}
echo sanitize_text_field($fontFamily);
?>
...
.sp-header{background: #F9F8F3;margin-bottom: 40px;padding-bottom:44.16px;padding-top:36.24px;}
...
.amp-category span a, .amp-category span{background: #17238f;color: #fff;font-size: 12px;font-weight: 600; display: inline-block;}
.amp-category span a{padding: 7px 10px;}
.amp-category span a:hover {color: #fff;}
.amp-category span:after{content:"/";display:inline-block;margin:0px 5px 0px 5px;position:relative;top:1px;color:rgba(0, 0, 0, 0.25);}
.amp-category span:last-child:after{display:none;}
.sp{width:100%;margin-top:0;display:inline-block;}
.amp-post-title{font-family:'Tiempos Headline', sans-serif;font-size:28px;font-weight: 600;line-height:31px;color: #000;margin:0;padding-top:15px;margin-bottom:19px;}
...
<?php } ?>
.ss-ic, .sp-athr, .amp-tags, .post-date{padding-bottom:20px;}
.sp-athr{padding-bottom:0;}
...
.sp-athr .amp-author {display: flex;align-items: center;}
.sp-athr .author-details, .sp-athr .author-details a{color: #241C15; font-weight: bold; font-size: 16px;}
.sp-athr .author-details .author-name { text-decoration: underline;}
...
.sp-athr{margin-top:0; clear: both;}
.sp-rt .ss-ic{padding-bottom: 10px;margin-bottom: 20px;}
<?php } ?>


.cntn-wrp{font-size:16px;color:#000;line-height:1.58;word-break: break-word;}
.cntn-wrp a {
...
.related_link .amp-related-post-title a {
	color: #000;
	font-size: 20px;
	font-weight: bold;
	line-height: 23px;
...
@media(max-width:1110px){
<?php if (!checkAMPforPageBuilderStatus(ampforwp_get_the_ID())){ ?>
    .cntr{width:100%;padding:0px 15px 0 16.56px;}
...
@media(max-width:480px){
    ...
    .amp-post-title {font-size: 28px;line-height: 31px;}
...
<?php }
if($redux_builder_amp['enbl-vimeo']){?>
.s_vimeo:after {
<?php if ( $ampforwp_font_icon == 'swift-icons' ){ ?>
	content: "\e940";
<?php }
...
.footer{margin-top: 80px; padding: 38px 0; 
...
<?php if ( is_active_sidebar( 'ampforwp-above-inside-footer'  ) ) : ?>
.f-w-f0{
padding-bottom: 38px;
width:100%;}
<?php endif; ?>
...
.w-bl .singel-team-section img {
	max-width: 100%;
	height: auto;
}

.w-bl .singel-team-section h2 {
	font-size: 30px;
    line-height: 34px;
    color: #fff;
    font-family: "Tiempos Headline", sans-serif;
...
.w-bl .singel-team-section .team-img-wrraper {
	line-height: 0; 
}

.w-bl .singel-team-section a.bdt-advanced-button {
	color: #17238F;
    border-style: solid;
    border-width: 1px 1px 1px 1px;
    border-color: #17238F;
    box-shadow: 5px 5px 0px 0px #17238F;
...
.w-bl .singel-team-section a.bdt-advanced-button:hover {
	color: #17238F;
    border-style: solid;
    border-width: 1px 1px 1px 1px;
    border-color: #17238F;
...
.get_in_touch .footer__button {
    margin-top: 27px;
    display: block;
    position: relative;
}
.get_in_touch .footer__button__background {
    box-shadow: 0.265rem 0.265rem 0 #facb10;
    height: 100%;
    left: 0;
    position: absolute;
    top: 0;
...
.get_in_touch .footer__button__box {
    background: #17238f;
    border: 1px solid #facb10;
    color: #facb10;
    font-size: 0.96rem;
    line-height: 1.2;
    padding: 0.7287rem 3.3125rem;
...
.cp_amp_social_profile_widget h2 {
...
.footer .footer__language__logo {
    display: block;
    text-align: center;
    width: 100%;
}

.footer .footer__language__logo__media {
	fill: #facb10;
    width: 9rem;
    margin-bottom: 1rem;
}
.cp_amp_language_widget.w-bl {
	margin-left: 0;
	margin-right: 0;
}
.cp_amp_language_widget_content {
    display: flex;
    justify-content: space-between;
    margin: auto;
    max-width: 80rem;
...
.footer__menu__language__group {
    width: 50%;
    text-align: left;
}

.footer__menu__language__group:first-of-type {
    padding-right: 0.8281rem;
}
.footer__menu__language__group:last-of-type {
    padding-left: 0.8281rem;
}

.footer__menu__language__group__icon {
    display: inline-block;
...
.footer__menu__language__group__text {
    display: inline-block;
    font-weight: 700;
...
.footer__menu__language__group__select {
    background: #17238f;
...
.ss-ic ul li .s_fb{	color:#fff;background:;}
.s_fb:after{
<?php if ( $ampforwp_font_icon == 'swift-icons' ){ ?>
		content: "\e92d";
<?php }
