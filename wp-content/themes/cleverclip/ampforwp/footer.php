...
<footer class="footer">
	...
	<div class="f-w-f0">
		<div class="cntr">
			<div class="f-w">
				<?php 
				$sanitized_sidebar = ampforwp_sidebar_content_sanitizer('ampforwp-above-inside-footer');
	            ...
	            ?>
	            <p class="footer__copyright"><?php amp_non_amp_link(); ?></p>
			</div>
		</div>
	</div>
	<?php endif; ?>
	...
	<?php endif; ?>
	<?php if (ampforwp_get_setting('swift-menu') && has_nav_menu( 'amp-footer-menu' )): ?>
	<div class="f-w-f2">
		<div class="cntr">
