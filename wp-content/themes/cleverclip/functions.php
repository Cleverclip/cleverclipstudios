                    ...
                    <div class="m-s-i">
                        <ul>
                            ...
                            <?php if (ampforwp_get_setting('enbl-telegram')) { ?>
                                <li>
                                    <a title="telegram" class="s_telegram"
                                       target="_blank" <?php ampforwp_nofollow_social_links(); ?>
        ...
        public function widget($args, $instance)
        {
            ...
            if (function_exists('ampforwp_is_amp_endpoint') && ampforwp_is_amp_endpoint()) {
                ...
                if ($translations) {
                    ...
                    <div class="footer__menu__language__group">
                        <svg class="footer__menu__language__group__icon" viewBox="0 0 29 28" fill="none"
...
/**
 * Fixed easy smooth scroll link render blocking script
 */
function fix_essl_enqueue_jquery()
{
